        ...
        function displayTopProducts(products) {
            ...
            products.forEach((product, index) => {
                ...
                row.innerHTML = `
                    <td class="py-4 px-6">
                        <div class="flex items-center">
                            <span class="w-8 h-8 rounded-full bg-gradient-to-r from-<?php echo $platformColor; ?> to-<?php echo $platformColor; ?>-600 text-white flex items-center justify-center text-sm font-bold">
                                ${index + 1}
                            </span>
                        </div>
                    </td>
